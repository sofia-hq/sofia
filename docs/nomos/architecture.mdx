...
<Danger>Do not get scared by the complexity of the architecture diagrams. They are designed to provide a clear understanding of how NOMOS operates at a high level, and each component plays a crucial role in the overall functionality of the framework.</Danger>
