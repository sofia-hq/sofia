...
<CardGroup cols={2}>
  <Card title="Lack of Determinism" icon="dice" iconType="solid">
    Prompt-based agents provide inconsistent behavior where small changes in wording can dramatically alter agent performance, making them unreliable for production use.
  </Card>
  <Card title="Monolithic Architecture" icon="box" iconType="solid">
    Everything is bundled into massive prompts—behavior instructions, task definitions, tool access—creating complexity that's difficult to manage and debug.
  </Card>
  <Card title="Testing Challenges" icon="bug" iconType="solid">
    Traditional software testing practices don't apply to prompt-based agents, making it nearly impossible to ensure quality and reliability.
  </Card>
  <Card title="Collaboration Barriers" icon="users-x" iconType="solid">
    Teams struggle to work together on agent development when everything depends on carefully crafted prompts that are fragile and interdependent.
  </Card>
</CardGroup>
