...
<Callout type="info">
  Type annotations are important for SOFIA to understand your tools' interfaces and generate proper documentation.
</Callout>
...
<Callout type="warning">
  Avoid creating tools with side effects that can't be undone, especially for destructive operations.
</Callout>
