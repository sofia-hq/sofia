...
<Tabs>
  <Tab title="Production">
    ...
    <CardGroup cols={2}>
      <Card title="OpenAI GPT-4o" icon="star">
        Best overall performance, most reliable
      </Card>
      <Card title="Anthropic Claude 3.5 Sonnet" icon="brain">
        Excellent reasoning and coding capabilities
      </Card>
      <Card title="Mistral Large" icon="zap">
        Strong performance, competitive pricing
      </Card>
      <Card title="Google Gemini 2.0 Flash" icon="flash">
  ...
  <Tab title="Development">
    ...
    <CardGroup cols={2}>
      <Card title="OpenAI GPT-4o-mini" icon="dollar">
        Fast and cost-effective
      </Card>
      <Card title="Anthropic Claude 3.5 Haiku" icon="balance-scale">
        Good balance of capability and speed
      </Card>
      <Card title="Mistral Small" icon="piggy-bank">
...
<AccordionGroup>
  <Accordion title="API Key Not Found">
    Ensure environment variables are set correctly in your shell profile or `.env` file
  </Accordion>
