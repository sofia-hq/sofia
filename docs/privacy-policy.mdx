...
<Tabs>
  ...
  <Tab title="Web Services">
    ### NOMOS Visual Builder

    Our web-based visual builder (nomos.dowhile.dev) may collect:
...
<AccordionGroup>
  <Accordion title="Service Provision">
    - Provide and maintain the NOMOS visual builder
...
<Tabs>
  ...
  <Tab title="Data Location">
    ...
    - **Visual Builder**: Data stored in US-based cloud services
...
<AccordionGroup>
  ...
  <Accordion title="Web Services Data">
    ...
    - Delete your visual builder account
