...
<CardGroup cols={2}>
  <Card
    title="Barista Agent"
    icon="coffee"
    href="../cookbook/examples/barista/"
  >
  ...
  <Card
    ...
    icon="chart-line"
    href="../cookbook/examples/financial-advisor/"
  >
  ...
  <Card
    title="General Bot"
    icon="robot"
    href="../cookbook/examples/general-bot/"
  >
  ...
  <Card
    ...
    icon="plane"
    href="../cookbook/examples/travel-itinery-planner/"
  >
  ...
  <Card
    ...
    icon="git-branch"
    href="../cookbook/examples/git-search/"
  >
  ...
  <Card
    ...
    icon="code"
    href="../cookbook/examples/typescript-sdk-example/"
  >
