...
<CardGroup cols={2}>
  <Card
    ...
    icon="puzzle-piece"
  >
    Use existing Python functions without writing wrapper code
  </Card>
  <Card
    title="Automatic Documentation"
    icon="book"
  >
    Function docstrings generate tool descriptions and parameter docs
  </Card>
  <Card
    title="Simplified Configuration"
    icon="gear"
  >
    Easily reference any Python function in your environment
  </Card>
  <Card
    title="String Compatibility"
    icon="link"
  >
    Function returns must be string representable
  </Card>
</CardGroup>

<Warning>
Make sure the package is installed in your environment and function returns an output that is string representable.
</Warning>
